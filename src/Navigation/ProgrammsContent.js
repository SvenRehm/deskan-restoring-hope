export const ProgrammsContent = [
   {
      ...
      desc: "no description",
      paragraph: `Now, more than ever, it is important for us to come together as communities to celebrate humanity, ￼ compassion and understanding, and to exercise the power we all have to make a difference. We know you can reach out to many others, but we are asking you to help us to help others.
   ...
   },
   {
      ...
      paragraph: `The clinic also provides donated reading glasses to those in-need and over-the-counter medications are dispensed at the clinic which is staffed by a local Pharmacist.
   ...
   },
   {
      ...
      header: "Food Pantry",
      desc: "Deskan provided grocery boxes of food to over 2,500 families. Deskan also helped serve over 21,426 hot meals at homeless shelters in Atlanta, Local Hotel and Extended Stay Motel in Decatur and Stone Mountain area..",
      ...
      Deskan’s team seeks to develop a plan that effects behavioral changes through Education Programs, Life skills Training, Mentoring, Conflict Resolution and Community Involvement.
      ...
      You can view our online menu for more information about our monthly menu.`,
   },
   {
      id: 5,
      title: "Homelessness",
